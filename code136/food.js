...
async function FoodApp(customer) 
{
    try
    {
        console.log(await placeOrder(customer));
        console.log(await packOrder(customer));
        console.log(await pickDelivery(customer));
        console.log(await delivery(customer));               
    }
    catch(error)
    {
        console.log(error);
